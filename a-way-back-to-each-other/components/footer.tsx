      ...
      <div className="container mx-auto px-4 py-12">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          {/* Logo & Mission */}
            <div className="text-center md:text-left">
              ...
              <p className="text-sm text-muted-foreground italic">A way back to each other</p>
            </div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6">
            ...
            >
              ...
              <span>Security auditors: review our code</span>
            </a>
            <a 
              href="https://github.com/PangaeaHQ" 
              target="_blank" 
        ...
        <div className="mt-12 pt-8 border-t border-border/50 text-center">
          <p className="text-sm text-muted-foreground">
            Pangaea doesn&apos;t save people. It removes friction so people can save each other.
          </p>
          <p className="text-xs text-muted-foreground/70 mt-4">
            Built on open protocols • Privacy by design • Made with love
          </p>
        </div>
      </div>
    </footer>
